...
class NeonSoilDataTranslator(Translator):
    ...
    def _translate_nucleotide_sequencing(
        ...
        return nmdc.NucleotideSequencing(
            ...
            instrument_name=f"{_get_value_or_none(nucleotide_sequencing_row, 'sequencingMethod')} {_get_value_or_none(nucleotide_sequencing_row, 'instrument_model')}",
    ...
    def get_database(self) -> nmdc.Database:
        ...
        for (
            ...
            nucleotide_sequencing_id = neon_to_nmdc_nucleotide_sequencing_ids[dna_sample_id]
