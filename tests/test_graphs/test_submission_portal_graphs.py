...
from nmdc_runtime.site.graphs import translate_metadata_submission_to_nmdc_schema_database
...
MOCK_PORTAL_SUBMISSION = {
    ...
    "metadata_submission": {
        ...
        "contextForm": {
            "datasetDoi": "10.12345/10.12345/00000000"
        },
        "templates": [
            "plant-associated"
        ],
...
def test_translate_metadata_submission_to_nmdc_schema_database():
    ...
    job = translate_metadata_submission_to_nmdc_schema_database.to_job(resource_defs=resource_defs)
    run_config = {
        "ops": {
            "export_json_to_drs": {
                "config": {
